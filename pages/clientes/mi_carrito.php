...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-shopping-cart"></i> Mi Carrito</h1>
      <ol class="breadcrumb">
    ...
    <div class="callout callout-helsa">
        <h4>Verifique sus productos</h4>
        <p>Una vez hecha la compra ya no podrá modificar su pedido, no podrá eliminar o adquirir más productos.
            Si deseara adquirir mas productos, tendrá que hacerlo en una nueva compra.</p>
    </div>

      <!-- Default box -->
      <div class="box box-helsa">
        <div class="box-header with-border">
            <p class="box-title"><i class="glyphicon glyphicon-list-alt"></i> Listado de Productos en el Carrito de Compras</p>
        </div>
        <div class="box-body"> 
          <div id="divListadoCarrito" class="table-responsive"></div>
        </div>
        <!-- /.box-body -->
      </div>
      <!-- /.box -->
...
<script type="text/javascript" src="../../js/clientes/mi_carrito.js"></script>
</body>
</html>